// src/components/movie-card/movieTrend.tsx

import React, { useContext } from "react";
import { MovieDataType } from "../../assets/data"; // Assuming you corrected this import
...
const MovieTrendCard = ({ movie }: MovieTrendCardProps) => {
  ...
  // Correct the action type
  const handleToggleBookmark = (id: string) => {
    dispatch({ type: "TOGGLE_BOOKMARK", id }); // Corrected action type
  };
